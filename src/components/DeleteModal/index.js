...
const DeleteModal = ({show, onClose, text, isActivity = true, confirmHandler}) => {
    return (
        <>
            ...
            <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex items-center justify-center z-20 ${show ? 'block' : 'hidden'}`} data-cy="modal-delete">
